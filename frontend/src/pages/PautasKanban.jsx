  ...
  return (
    <>
      ...
      <div className="flex gap-6 overflow-x-auto pb-4">
        {COLUMNS.map((col) => (
          <div key={col.estado} className="flex-shrink-0 w-80">
            {/* Column header */}
            ...
            <div className="space-y-3">
              {col.items.map((p) => (
                <Link key={p.numero_OT} to={`/pautas/${p.numero_OT}`} className="block bg-white rounded-xl p-4 shadow-sm border border-slate-100 hover:shadow-md hover:border-primary/20 transition-all">
