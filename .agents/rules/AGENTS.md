...
- Offload research, exploration, and parallel analysis via subagents
...
- Skip this for simple, obvius fixes -don't over-engineer
- Challenge your own work before presenting it 


### 6. Autonomus Bug Fizing 
...
6. **Capture Lessons**: Update ´tasks/lessons.med´ after corrections

## Core Principles 
- **Simplicity First**: Make every change as simple as posible. Impact minimal code. 
- **NO Laziness**: Find root causes. Notemporary fixes. Senior developer standars. 
