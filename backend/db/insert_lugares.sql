-- =========================================================
-- INSERTS PARA LA TABLA LUGAR (Jerarquía Estricta: Región -> Estado -> Ciudad)
-- =========================================================

-- 1. REGIONES (Padres principales, fk_lugar = NULL)
INSERT INTO LUGAR (nombre, tipo, descripcion, fk_lugar) VALUES
('Capital', 'Región', 'Región Capital', NULL),
('Central', 'Región', 'Región Central', NULL),
('Centro Occidental', 'Región', 'Región Centro Occidental', NULL),
('Guayana', 'Región', 'Región Guayana', NULL),
('Los Andes', 'Región', 'Región de Los Andes', NULL),
('Los Llanos', 'Región', 'Región de Los Llanos', NULL), 
('Oriental', 'Región', 'Región Oriental', NULL),
('Zuliana', 'Región', 'Región Zuliana', NULL);

-- 2. ESTADOS (Hijos de las Regiones)
-- Región Capital (1)
INSERT INTO LUGAR (nombre, tipo, descripcion, fk_lugar) VALUES
('Distrito Capital', 'Estado', 'Entidad Federal Distrito Capital', (SELECT id FROM LUGAR WHERE nombre = 'Capital' AND tipo = 'Región')),
('La Guaira', 'Estado', 'Estado La Guaira', (SELECT id FROM LUGAR WHERE nombre = 'Capital' AND tipo = 'Región')),
('Miranda', 'Estado', 'Estado Miranda', (SELECT id FROM LUGAR WHERE nombre = 'Capital' AND tipo = 'Región')),
-- Región Central (2)
('Aragua', 'Estado', 'Estado Aragua', (SELECT id FROM LUGAR WHERE nombre = 'Central' AND tipo = 'Región')),
('Carabobo', 'Estado', 'Estado Carabobo', (SELECT id FROM LUGAR WHERE nombre = 'Central' AND tipo = 'Región')),
('Cojedes', 'Estado', 'Estado Cojedes', (SELECT id FROM LUGAR WHERE nombre = 'Central' AND tipo = 'Región')),
-- Región Centro Occidental (3)
('Falcón', 'Estado', 'Estado Falcón', (SELECT id FROM LUGAR WHERE nombre = 'Centro Occidental' AND tipo = 'Región')),
('Lara', 'Estado', 'Estado Lara', (SELECT id FROM LUGAR WHERE nombre = 'Centro Occidental' AND tipo = 'Región')),
('Portuguesa', 'Estado', 'Estado Portuguesa', (SELECT id FROM LUGAR WHERE nombre = 'Centro Occidental' AND tipo = 'Región')),
('Yaracuy', 'Estado', 'Estado Yaracuy', (SELECT id FROM LUGAR WHERE nombre = 'Centro Occidental' AND tipo = 'Región')),
-- Región Guayana (4)
('Amazonas', 'Estado', 'Estado Amazonas', (SELECT id FROM LUGAR WHERE nombre = 'Guayana' AND tipo = 'Región')),
('Delta Amacuro', 'Estado', 'Estado Delta Amacuro', (SELECT id FROM LUGAR WHERE nombre = 'Guayana' AND tipo = 'Región')),
('Bolívar', 'Estado', 'Estado Bolívar', (SELECT id FROM LUGAR WHERE nombre = 'Guayana' AND tipo = 'Región')),
-- Región Los Andes (5)
('Barinas', 'Estado', 'Estado Barinas', (SELECT id FROM LUGAR WHERE nombre = 'Los Andes' AND tipo = 'Región')),
('Mérida', 'Estado', 'Estado Mérida', (SELECT id FROM LUGAR WHERE nombre = 'Los Andes' AND tipo = 'Región')),
('Táchira', 'Estado', 'Estado Táchira', (SELECT id FROM LUGAR WHERE nombre = 'Los Andes' AND tipo = 'Región')),
('Trujillo', 'Estado', 'Estado Trujillo', (SELECT id FROM LUGAR WHERE nombre = 'Los Andes' AND tipo = 'Región')),
-- Región Los Llanos (6)
('Apure', 'Estado', 'Estado Apure', (SELECT id FROM LUGAR WHERE nombre = 'Los Llanos' AND tipo = 'Región')),
('Guárico', 'Estado', 'Estado Guárico', (SELECT id FROM LUGAR WHERE nombre = 'Los Llanos' AND tipo = 'Región')),
-- Región Oriente (7)
('Anzoátegui', 'Estado', 'Estado Anzoátegui', (SELECT id FROM LUGAR WHERE nombre = 'Oriente' AND tipo = 'Región')),
('Nueva Esparta', 'Estado', 'Estado Nueva Esparta', (SELECT id FROM LUGAR WHERE nombre = 'Oriente' AND tipo = 'Región')),
('Sucre', 'Estado', 'Estado Sucre', (SELECT id FROM LUGAR WHERE nombre = 'Oriente' AND tipo = 'Región')),
('Monagas', 'Estado', 'Estado Monagas', (SELECT id FROM LUGAR WHERE nombre = 'Oriente' AND tipo = 'Región')),
-- Región Zuliana (8)
('Zulia', 'Estado', 'Estado Zulia', (SELECT id FROM LUGAR WHERE nombre = 'Zulia' AND tipo = 'Región'));
